...
interface CapitalComponentTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class CapitalComponentToken extends Contract {
  ...
  interface: CapitalComponentTokenInterface;
